...
<form method="POST" action="/games/{{ $game->id }}">
       ...
       {{ csrf_field() }}  
        ...
        <div>
            <label class="label" for="game_name">Game name</label>
