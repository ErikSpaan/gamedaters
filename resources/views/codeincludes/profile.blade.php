    ...
    <div class="profile_boxes">
        ...
        <form method="POST" action="/personalpages/{{ $personalpage->id }}">
            ...
            <div class="input_container">
                <input type="text" name="personal_firstname" placeholder="first name" value="{{ $personalpage->personal_firstname }}" class="input_profile_page">
                <input type="text" name="personal_lastname" placeholder="last name" value="{{ $personalpage->personal_lastname }}" class="input_profile_page">
                <input type="text" name="user_nickname" placeholder="nickname" value="{{ Auth::user()->name }}" class="input_profile_page">
                <input type="email" name="user_email" placeholder="email" value="{{ Auth::user()->email }}" class="input_profile_page">
                ...
                <div class="input_flex">
                    <input type="radio" name="personal_gender" {{ ($personalpage->personal_gender=='male') ? 'checked="checked" ' : '' }} value="male" class="input_radio"><span class="gender_span">male</span>
                </div>
                <div class="input_flex">
                    <input type="radio" name="personal_gender" {{ ($personalpage->personal_gender=='female') ? 'checked="checked" ' : '' }} value="female" class="input_radio"><span class="gender_span">female</span>
                </div>
                <div class="input_flex"> <input type="radio" name="personal_gender" {{ ($personalpage->personal_gender=='gender neutral') ? 'checked="checked" ' : '' }} value="gender neutral" class="input_radio"><span
                    class="gender_span">gender neutral</span>
                </div><br />
                <span class="separate_span">age</span>
                <input type="range" name="personal_age" min="18" max="99" placeholder="" value="{{ $personalpage->personal_age }}" class="input_range">
            </div>
            <div class="who_am_i">
                <textarea class="text_area" placeholder="write something about yourself..." name="personal_info">{{ $personalpage->personal_info }}</textarea>
            ...
            <form method="GET" action="/profilepages/{{ $personalpage->id }}">                
                ...
                <div class="filter_options">
                    ...
                    <div class="input_radio_box">
                        ...
                        <input type="radio" name="filter_gender" value="gender neutral" class="input_radio">gender neutral
                    </div>
                    <span class="separate_span">age</span>
                    <div><input type="range" name="filter_age" min="18" max="99" placeholder="" class="filter_age"></div>
                    <span class="separate_span">distance</span>
                    <div><input type="range" name="filter_distance" min="0" max="500" placeholder="" class="filter_age"></div>
