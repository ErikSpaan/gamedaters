...
<div class="profile_container">
    <div class="profile_boxes">
        <div class="photo_button_container">
            <div class="photo_box" id="photo_holder"><img src="{{ $personalpage->personal_image_url }}" class="photo_image"/></div>
        ...
        <div class="input_container">
            ...
            <input type="email" name="" placeholder="email" value="" class="input_profile_page">
        ...
        <div class="who_am_i">
            <textarea class="text_area" placeholder="write something about you..." value="{{ $personalpage->personal_info }}"></textarea>
